...
<header
		class="flex h-14 w-full shrink-0 items-center justify-between border-b border-border/40 bg-background/50 px-4 backdrop-blur-md sm:px-6"
>
	<!-- Brand & Navigation -->
	<div class="flex items-center gap-4 sm:gap-6">
		...
		<!-- Navigation Pills -->
		<nav class="flex items-center gap-1 rounded-lg border border-border/40 bg-muted/30 p-1">
			<a
					href={resolve('/')}
					class={cn(
