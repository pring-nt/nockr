<script lang="ts">
    ...
    import { Plus, Target, GraduationCap, PenLine, Check } from 'lucide-svelte';
    ...
    <main class="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card class="glass border-border/40">
            <CardContent class="p-5 sm:p-6 space-y-5">
                ...
                <!-- Degree Progress Bar & Explicit Total Config -->
                        ...
                        {#if isEditingTotal}
                            <div class="flex items-center gap-1.5">
                                ...
                                <Input
                                        ...
                                        autofocus
                                />
                                <Button size="icon" variant="ghost" class="h-7 w-7 text-primary hover:bg-primary/10" onclick={saveTotalUnits}>
                                    <Check size={14} />
                                </Button>
                            </div>
                        {:else}
        ...
        {#if $appStore.terms.length === 0}
            <div class="glass border-border/30 rounded-xl py-12 px-4 text-center space-y-3">
        ...
        <Button
                onclick={addTerm}
                variant="ghost"
                class="w-full gap-2 glass border border-border/30 hover:bg-muted/30 text-foreground py-5"
        >
            <Plus size={16} />
            Add Term
        </Button>
